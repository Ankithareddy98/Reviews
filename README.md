...
Overall, the flow of the application looks something like this:

- Import the reviews data as an array of objects.
...
- Set up a button to display a random person's review. This button will select a random index in the reviews array and use it to display the corresponding person's review.
